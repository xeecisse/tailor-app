        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl shadow-2xl p-8 border-2 border-green-300">
            ...
            <p className="text-gray-600 text-center mb-6">
              If an admin account exists with <span className="font-semibold">{email}</span>, we've sent a password reset link. 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-navy-50 via-brand-orange-50 to-brand-navy-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        >
          <ArrowLeft size={20} /> Back to Admin Login
        </Link>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border-2 border-gray-100">
          ...
          <p className="text-center text-gray-600">
            ...
            <Link to="/admin/login" className="text-brand-navy font-bold hover:text-brand-navy-dark transition-all">
              Back to login
            </Link>
          </p>
        </div>
