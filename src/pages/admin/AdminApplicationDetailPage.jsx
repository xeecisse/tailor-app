...
export default function AdminApplicationDetailPage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      setNotification({ type: 'success', message: 'Tailor approved successfully!' });
      setTimeout(() => setNotification(null), 4000);
    } catch (error) {
      console.error('Failed to approve tailor:', error);
      setNotification({ type: 'error', message: 'Failed to approve tailor. Please try again.' });
      setTimeout(() => setNotification(null), 4000);
    } finally {
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      setNotification({ type: 'success', message: 'Tailor rejected successfully!' });
      setTimeout(() => setNotification(null), 4000);
    } catch (error) {
      console.error('Failed to reject tailor:', error);
      setNotification({ type: 'error', message: 'Failed to reject tailor. Please try again.' });
      setTimeout(() => setNotification(null), 4000);
    } finally {
      setActionLoading(false);
    }
